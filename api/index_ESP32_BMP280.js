...
startDatabase().then(async() => {
    await insertMeasurement({id:'00', t:'18', h:'78', p:'50'});
    await insertMeasurement({id:'00', t:'19', h:'77', p:'50'});
    await insertMeasurement({id:'00', t:'17', h:'77', p:'50'});
    await insertMeasurement({id:'01', t:'17', h:'77', p:'50'});
    ...
    db.public.none("INSERT INTO devices VALUES ('01', 'Fake Device 01', '234567')");
        db.public.none("INSERT INTO devices VALUES ('02', 'ESP32_BMP280', '00001')");
